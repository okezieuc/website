    ...
    <Layout>
      ...
      <article class="prose sm:prose lg:prose-lg xl:prose-2xl px-4 mx-auto my-12 md:my-24">
        ...
        <p>
          ...
          Studymono (“we,” “us” or “our”), concerning your access to and use of
          the www.studymono.com website as well as any other media form, media
        ...
        <ol>
          ...
          <li>engage in unauthorized framing of the Site.</li>
          <li>
        ...
        <p>
          ...
          TRANSMITTED TO OR THROUGH THE SITE BY ANY THIRD PARTY, AND/OR (5) ANY
