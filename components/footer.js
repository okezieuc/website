      ...
      <Container>
        <div class="flex flex-col items-center py-8 mx-auto max-w-7xl sm:flex-row">
          ...
          <p class="mt-4 text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l sm:border-gray-200 sm:mt-0">
            © 2022 Studymono - Educational Resources for Nigerians
          </p>
          <span class="inline-flex justify-center mt-4 space-x-5 sm:ml-auto sm:mt-0 sm:justify-start">
            <a
              href="https://twitter.com/studymono"
            ...
            <a
              href="https://github.com/studymono"
              class="text-gray-400 hover:text-gray-500"
            >
        ...
        <div>
          ...
          <p class="my-4 text-black">Built with ❤ by Okezie and the team</p>
        </div>
      </Container>
    </section>
  );
